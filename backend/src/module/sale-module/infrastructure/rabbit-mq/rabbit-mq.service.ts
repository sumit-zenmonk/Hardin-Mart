...
import { saleRabbitMQConfig } from "./rabbit-mq.config";
...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    private async setupInitialCreation() {
        ...
        const { queueName, exchanges } = saleRabbitMQConfig;
    ...
    async consumeMessages<TPayload = unknown>(
        ...
        await this.commonRabbitMQService.consumeMessages(this.channel, saleRabbitMQConfig.queueName, callback);
    }
