...
export class outboxMigration1778505599999 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "sale_schema"."outbox_exchange_name_enum" AS ENUM('user.exchange','order.exchange')`);
        await queryRunner.query(`CREATE TYPE "sale_schema"."outbox_routing_key_enum" AS ENUM('user.registered','order.billed','order.placed','order.shipping.label.created')`);
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: "routing_key", type: `"sale_schema"."outbox_routing_key_enum"`, isNullable: false, },
