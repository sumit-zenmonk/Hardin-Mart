...
import { shipmentRabbitMQConfig } from "./rabbit-mq.config";
...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    private async setupInitialCreation() {
        ...
        const { queueName, exchanges } = shipmentRabbitMQConfig;
    ...
    async consumeMessages<TPayload = unknown>(
        ...
        await this.commonRabbitMQService.consumeMessages(this.channel, shipmentRabbitMQConfig.queueName, callback);
    }
